<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editcategory.aspx.cs" Inherits="techfix.admin_panel.editcategory" %>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="form-group">
                                <label for="fileImage" class="text-white">Upload Image:</label>
                                <asp:FileUpload ID="fileImage" runat="server" CssClass="form-control" />
                                <asp:Label ID="lblCurrentImage" runat="server" CssClass="text-white mt-2" />
                            </div>
