<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="quote.aspx.cs" Inherits="techfix.admin_panel.quote" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="quote-list">
            ...
            <button type="button" class="back" onclick="location.href='supplier1_order.aspx'">Back</button>
