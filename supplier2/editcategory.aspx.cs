...
namespace techfix.supplier2
{
    public partial class editcategory : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    Response.Redirect("showcategorys1.aspx?error=invalid");
                }
            }
        }
        ...
        private void LoadCategoryData(int categoryId)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                else
                {
                    ...
                    Response.Redirect("showcategorys1.aspx?error=notfound");
                }
                conn.Close();
            }
        }
        ...
        private void UpdateCategory(int categoryId, string categoryName)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("UPDATE s2category SET category_name = @categoryName WHERE id = @id", conn);
                ...
                if (rowsAffected > 0)
                {
                    ...
                    Response.Redirect("showcategorys1.aspx?update=success");
                }
                else
                {
